...
option_deanonymization = FeedbackQuestionSettingsOption.create!(
  ...
  descriptor: 'Among those who can see the results, who should be able to see which users submitted which responses? (Note: you can also make the entire form anonymous when releasing the results)',
  quantitative: false,
  default: nil
)
FeedbackQuestionSettingsValue.create!(
